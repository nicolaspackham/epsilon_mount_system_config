EPS_Mounts_Config = {
    ...
    SpawnerModel = {"models/eng_fixer/pm_coruscant_eng_fixer.mdl"}, -- Model(s)
    SpawnerStance = {"pose_standing_01", "pose_standing_02", "idle_all_01", "idle_all_02"}, -- Stance(s)
    ...
    -- Prefix Stuff
    Prefix = "Mount System", -- Feel free to change to your Server Name.
